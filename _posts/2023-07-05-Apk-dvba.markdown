...
Una vez ubicado el archivo, se evalua el contenido de las línes de codigo y se identifica que es necesario modificar el proceso de la aplicación de forma que no entre en el bloque de códgio específico de la línea 258. 
